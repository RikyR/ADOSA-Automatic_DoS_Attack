...
textTutor2 = Label(loginFrame, text="1-This program is only for Chrome!\n2-Every time you update Chrome, you need to check if there is \na new Web Driver for that at chromedriver.chromium.org/downloads", font="Default 14 bold", bg="black", fg="white").pack()
...
startAButton.pack()
textTutor2 = Label(attackFrame, text="DO NOT TRY TO MAKE THE CHROME WINDOW SMALLER \nOR THE PROGRAM WON'T WORK!", font="Default 18 bold", bg="black", fg="red").pack(pady=10)
###############################################
